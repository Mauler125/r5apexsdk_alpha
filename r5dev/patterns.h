...
namespace
{
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* ==== CVENGINECLIENT ================================================================================================================================================== */
	DWORD64 p_CVEngineClient_CommandExecute = FindPatternV2("r5apex.exe", (const unsigned char*)"\x48\x89\x5C\x24\x08\x57\x48\x83\xEC\x20\x48\x8D\x0D\x27\x61\xa5\x1E\x41\x8B\xD8", "xxxx?xxxxxxxx????xxx");
	void (*CVEngineClient_CommandExecute)(void* self, const char* cmd) = (void (*)(void*, const char*))p_CVEngineClient_CommandExecute; /*48 89 5C 24 ?? 57 48 83 EC 20 48 8D 0D ?? ?? ?? ?? 41 8B D8*/

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* ==== CVENGINESERVER ================================================================================================================================================== */
	DWORD64 p_CVEngineServer_IsPersistenceDataAvailable = FindPatternV2("r5apex.exe", (const unsigned char*)"\x3B\x15\x00\x00\x00\x00\x7D\x33", "xx????xx");
	bool (*CVEngineServer_IsPersistenceDataAvailable)(__int64 entidx, int clientidx) = (bool (*)(__int64, int))p_CVEngineServer_IsPersistenceDataAvailable; /*3B 15 ?? ?? ?? ?? 7D 33*/
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* ==== ICONVAR ========================================================================================================================================================= */
	DWORD64 p_ConVar_IsFlagSet = FindPatternV2("r5apex.exe", (const unsigned char*)"\x48\x8B\x41\x48\x85\x50\x38", "xxxxxxx");
	bool (*ConVar_IsFlagSet)(int** cvar, int flag) = (bool (*)(int**, int))p_ConVar_IsFlagSet; /*48 8B 41 48 85 50 38*/

	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/* ==== SQUIRREL ======================================================================================================================================================== */
	DWORD64 p_SQVM_Print = FindPatternV2("r5apex.exe", (const unsigned char*)"\x48\x8B\xC4\x48\x89\x50\x10\x4C\x89\x40\x18\x4C\x89\x48\x20\x53\x56\x57\x48\x81\xEC\x30\x08\x00\x00\x48\x8B\xDA\x48\x8D\x70\x18\x48\x8B\xF9\xE8\x00\x00\x00\xFF\x48\x89\x74\x24\x28\x48\x8D\x54\x24\x30\x33", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx???xxxxxxxxxxxx");
	...
	{
		std::cout << "+--------------------------------------------------------+" << std::endl;
		std::cout << "| CVEngineClient_CommandExecute : " << std::hex << std::uppercase << CVEngineClient_CommandExecute << std::setw(20) << " |" << std::endl;
