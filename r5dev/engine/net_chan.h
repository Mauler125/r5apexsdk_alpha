...
namespace
{
	...
	bool (*NET_ReceiveDatagram)(int, netpacket_t*, bool) = (bool (*)(int, netpacket_t*, bool))p_NET_ReceiveDatagram.GetPtr(); /*E8 ?? ?? ?? ?? 84 C0 75 35 48 8B D3*/
	...
	void*(*NET_SendDatagram)(SOCKET s, const char* buf, int len, int flags) = (void*(*)(SOCKET, const char*, int, int))p_NET_SendDatagram.GetPtr(); /*48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 41 56 41 57 48 81 EC ?? 05 00 00*/
	...
	void (*NET_PrintFunc)(const char* a1) = (void(*)(const char*))p_NET_PrintFunc.GetPtr(); /*48 89 54 24 10 4C 89 44 24 18 4C 89 4C 24 20 C3 48*/
}
