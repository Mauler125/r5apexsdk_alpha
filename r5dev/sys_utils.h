...
namespace
{
	...
	void* Sys_Error = (void*)p_Sys_Error.GetPtr(); /*48 89 4C 24 08 48 89 54 24 10 4C 89 44 24 18 4C 89 4C 24 20 53 55 41 54 41 56 B8 58 10 00 00 E8*/
	...
	std::int64_t(*Sys_LoadAsset)(const CHAR* lpFileName, std::int64_t a2, LARGE_INTEGER* a3) = (std::int64_t(*)(const CHAR*, std::int64_t, LARGE_INTEGER*))p_Sys_LoadAsset.GetPtr();/*48 89 74 24 10 48 89 7C 24 18 41 56 48 83 EC 40 33*/
