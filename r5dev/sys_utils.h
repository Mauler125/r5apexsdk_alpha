...
namespace
{
	...
	int64_t(*Sys_LoadAsset)(const CHAR* lpFileName, int64_t a2, LARGE_INTEGER* a3) = (int64_t(*)(const CHAR*, int64_t, LARGE_INTEGER*))p_Sys_LoadAsset;/*48 89 74 24 10 48 89 7C 24 18 41 56 48 83 EC 40 33*/
