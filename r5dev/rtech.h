...
namespace
{
	...
	DWORD64 p_RTech_FormatPak = 0x140362950;//FindPatternV2("r5apex.exe", (const unsigned char*)"\x4C\x89\x44\x24\x18\x48\x89\x54\x24\x10\x53\x48\x83\xEC\x50\x48", "xxxxxxxxxxxxxxxx");
	char* (*RTech_FormatPak)(char* a1, const char* fmt, ...) = (char* (*)(char*, const char*, ...))p_RTech_FormatPak; /*4C 89 44 24 18 48 89 54 24 10 53 48 83 EC 50 48*/

	DWORD64 p_RTech_FormatPak2 = 0x14022F1C0;//FindPatternV2("r5apex.exe", (const unsigned char*)"\x4C\x89\x44\x24\x18\x48\x89\x54\x24\x10\x53\x48\x83\xEC\x50\x48", "xxxxxxxxxxxxxxxx");
	std::size_t (*RTech_FormatPak2)(char* a1, std::size_t a2, char* fmt, ...) = (std::size_t (*)(char*, std::size_t, char*, ...))p_RTech_FormatPak2; /*4C 89 44 24 18 48 89 54 24 10 53 48 83 EC 50 48*/

	DWORD64 p_RTech_LoadFile = 0x140439300;
	int64_t (*RTech_LoadFile)(const CHAR* a1, int64_t a2, LARGE_INTEGER* a3) = (int64_t(*)(const CHAR*, int64_t, LARGE_INTEGER*))p_RTech_LoadFile;
...
void AttatchRTechHooks();
void DetatchRTechHooks();
