...
namespace
{
	...
	std::int64_t(*IAppSystem_Main)(std::int64_t a1, std::int64_t a2) = (std::int64_t(*)(std::int64_t, std::int64_t))p_IAppSystem_Main; /*48 8B C4 55 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC 60*/
