...
namespace
{
	...
	void PrintHAddress() // Test the sigscan results
	{
		...
		std::cout << "| NET_PrintFunc            : " << std::hex << std::uppercase << p_NET_PrintFunc           << std::setw(20) << " |" << std::endl;
		std::cout << "+--------------------------------------------------------+" << std::endl;
		...
		std::cout << "+--------------------------------------------------------+" << std::endl;
		std::cout << "| FrameStageNotify         : " << std::hex << std::uppercase << p_FrameStageNotify        << std::setw(20) << " |" << std::endl;
		std::cout << "+--------------------------------------------------------+" << std::endl;
		std::cout << "| MSG_EngineError          : " << std::hex << std::uppercase << p_MSG_EngineError         << std::setw(20) << " |" << std::endl;
		std::cout << "| Sys_PrintFunc            : " << std::hex << std::uppercase << p_Sys_PrintFunc           << std::setw(20) << " |" << std::endl;
		std::cout << "+--------------------------------------------------------+" << std::endl;

		// TODO implement error handling when sigscan fails or result is 0
	}

	extern bool g_bToggledDevFlags = true;
	extern bool g_bToggledNetTrace = false;
