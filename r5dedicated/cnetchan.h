...
namespace
{
	...
	int64_t(*NET_Init)(char a1) = (int64_t(*)(char))p_NET_Init; /*48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 48 89 7C 24 20 41 54 41 56 41 57 48 81 EC C0 01 00*/
	...
	char (*NET_ReceiveDatagram)(int, void*, bool) = (char (*)(int, void*, bool))p_NET_ReceiveDatagram; /*E8 ?? ?? ?? ?? 84 C0 75 35 48 8B D3*/
